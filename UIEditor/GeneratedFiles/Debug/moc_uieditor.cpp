...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UIEditor_t, stringdata) + ofs \
...
void UIEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UIEditor *_t = static_cast<UIEditor *>(_o);
        switch (_id) {
        case 0: _t->onBtnTestClick(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject UIEditor::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_UIEditor.data,
      qt_meta_data_UIEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UIEditor.stringdata))
        return static_cast<void*>(const_cast< UIEditor*>(this));
