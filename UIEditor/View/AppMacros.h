...
static Resource winResource	   =  { cocos2d::CCSizeMake(960, 640),   "win"    };
...
#define TITLE_FONT_SIZE  (cocos2d::CCEGLView::sharedOpenGLView()->getDesignResolutionSize().width / winResource.size.width * 24)
